      ...
      {loggedIn ?
        ...
        <main id="notLoggedIn">
          <p id="loggedOutText">
            ...
            home of reviews for games that you've never even heard of! Don't google them though, you'll challenge the whole legitimacy of this website. If you don't know or have a username, feel free to use <span id="boldStart">"tickle122"</span> to log in, don't hold it against me, I didn't generate the names.
          </p>
        </main>}
    </div>
  );
